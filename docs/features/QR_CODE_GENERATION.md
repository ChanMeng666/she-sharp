...
<QRCodeDisplay
  url="https://www.shesharp.org.nz/mentorship/mentee/apply?programme=her-waka"
  size={256}
  label="Scan to apply"
  showDownload
...
const url = 'https://www.shesharp.org.nz/mentorship/mentee/apply?programme=her-waka';
...
<svg xmlns="http://www.w3.org/2000/svg" width="${canvasW}" height="${canvasH}" viewBox="0 0 ${canvasW} ${canvasH}">
  ...
  <text x="${canvasW / 2}" y="${qrY + qrSize + 72}" text-anchor="middle"
        ...
        fill="#94a3b8">www.shesharp.org.nz/your/path</text>
  <!-- Bottom branding -->
