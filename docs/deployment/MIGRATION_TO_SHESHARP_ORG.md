...
#### 2. Pushing Code & Deployment

**Git push to `main` branch automatically triggers deployment via GitHub Actions.**
...
3. Create a new token (recommended: set a long expiration or "No expiration")
