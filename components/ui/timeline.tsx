        ...
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="md:h-10 absolute left-3 h-6 w-6 md:w-10 rounded-full bg-muted border border-brand/30 flex items-center justify-center">
            ...
            <div className="relative w-full pl-14 md:pl-0">
              <h3 className="md:hidden block mb-4 text-left text-2xl font-bold text-foreground">
                {item.title}
              </h3>
              {item.content}
            </div>
