          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            ...
            <div className="flex-1 text-white order-2 lg:order-1">
              ...
              <blockquote className="text-center lg:text-left text-base md:text-lg mb-8 space-y-4">
                <p>
                  <span className="text-white">"</span>As the Founder of She Sharp, I am proud to lead an organisation dedicated to empowering women in tech. Despite women making up over half of the population, they represent only 20% of roles in STEM fields.
                </p>
                <p>
