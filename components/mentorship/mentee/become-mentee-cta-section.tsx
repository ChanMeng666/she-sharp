...
export function BecomeMenteeCTASection() {
  ...
  return (
    <Section id="become-mentee-cta" bgColor="white" className="py-16 sm:py-20 lg:py-28">
      <Container size="full">
            ...
            <div className="flex flex-col gap-10">
              <div>
                ...
                <p className="text-base md:text-lg text-ink-600 max-w-2xl">
                  {applicationsOpen
                    ? "Take the first step towards transforming your career with personalised mentorship from industry leaders."
