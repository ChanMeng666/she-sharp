 ...
 *
 * Usage:
 *   BASE_URL=https://www.shesharp.org.nz npx tsx scripts/send-admin-invitation.ts <email> [--dry-run]
 *
 * Examples:
 *   BASE_URL=https://www.shesharp.org.nz npx tsx scripts/send-admin-invitation.ts admin@example.com --dry-run
 *   BASE_URL=https://www.shesharp.org.nz npx tsx scripts/send-admin-invitation.ts admin@example.com
 */
...
if (!targetEmail || !targetEmail.includes('@')) {
  console.error('\nUsage: BASE_URL=https://www.shesharp.org.nz npx tsx scripts/send-admin-invitation.ts <email> [--dry-run]\n');
  process.exit(1);
}
...
if (!baseUrl || baseUrl.includes('localhost')) {
  ...
  console.error('Usage: BASE_URL=https://www.shesharp.org.nz npx tsx scripts/send-admin-invitation.ts <email>');
  process.exit(1);
}
