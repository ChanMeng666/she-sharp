...
export const KNOWN_UNREFERENCED: Array<{ path: string; reason: string }> = [
  ...
  // referenced twin is missing.
  { path: "/img/events/aotearoa-ai-hackathon-festival-2026/cover-email.jpg", reason: "newsletter email-safe cover twin; referenced by an absolute URL in a newsletter issue fixture, which refs.ts excludes by design. Verified by scripts/newsletter/email-covers.ts --check" },
  ...
  // `npx tsx scripts/newsletter/email-covers.ts --check`, which fails when a
  // referenced twin is missing.
  { path: "/img/events/event-lesmills-03-september-2026/cover-email.jpg", reason: "newsletter email-safe cover twin; referenced by an absolute URL in a newsletter issue fixture, which refs.ts excludes by design. Verified by scripts/newsletter/email-covers.ts --check" },
  ...
  // `npx tsx scripts/newsletter/email-covers.ts --check`, which fails when a
  // referenced twin is missing.
  { path: "/img/events/her-waka-june-2026/cover-email.jpg", reason: "newsletter email-safe cover twin; referenced by an absolute URL in a newsletter issue fixture, which refs.ts excludes by design. Verified by scripts/newsletter/email-covers.ts --check" },
  ...
  // `npx tsx scripts/newsletter/email-covers.ts --check`, which fails when a
  // referenced twin is missing.
  { path: "/img/events/peyvand-academy-13-june-2026/cover-email.jpg", reason: "newsletter email-safe cover twin; referenced by an absolute URL in a newsletter issue fixture, which refs.ts excludes by design. Verified by scripts/newsletter/email-covers.ts --check" },
  ...
  // `npx tsx scripts/newsletter/email-covers.ts --check`, which fails when a
  // referenced twin is missing.
  { path: "/img/events/peyvand-academy-20-june-2026/cover-email.jpg", reason: "newsletter email-safe cover twin; referenced by an absolute URL in a newsletter issue fixture, which refs.ts excludes by design. Verified by scripts/newsletter/email-covers.ts --check" },
  ...
  // `npx tsx scripts/newsletter/email-covers.ts --check`, which fails when a
  // referenced twin is missing.
  { path: "/img/events/she-sharp-and-myob-working-smarter/cover-email.jpg", reason: "newsletter email-safe cover twin; referenced by an absolute URL in a newsletter issue fixture, which refs.ts excludes by design. Verified by scripts/newsletter/email-covers.ts --check" },
