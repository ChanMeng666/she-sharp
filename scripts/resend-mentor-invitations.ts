 ...
 *
 * Usage:
 *   BASE_URL=https://www.shesharp.org.nz npx tsx scripts/resend-mentor-invitations.ts --dry-run
 *   BASE_URL=https://www.shesharp.org.nz npx tsx scripts/resend-mentor-invitations.ts
 */
...
async function main() {
  ...
  if (!baseUrl || baseUrl.includes('localhost')) {
    ...
    console.error('Usage: BASE_URL=https://www.shesharp.org.nz npx tsx scripts/resend-mentor-invitations.ts');
    process.exit(1);
  }
