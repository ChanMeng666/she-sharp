...
export interface DeckSkin {
  ...
  surface: SurfaceSpec;
  /**
   * What this deck puts behind She Sharp's own slides.
   *
   * Defaults to the archive in the deck's chosen weave, which is the right
   * answer for most events: the organisational sequence is the organisation's
   * record of itself and the photographs belong there.
   *
