...
[Official Site](https://www.shesharp.org.nz/) · [Events](#events) · [Mentorship](#mentorship) · [Documentation](#documentation) · [Contact](#contact)

<br/>

[![🚀 Visit Live Site 🚀](https://gradient-svg-generator.vercel.app/api/svg?text=%F0%9F%9A%80Visit%20Live%20Site%F0%9F%9A%80&color=ffffff&height=60&gradientType=radial&duration=6s&color0=9b2e83&template=pride-rainbow)](https://www.shesharp.org.nz/)
...
<a href="https://www.shesharp.org.nz/">
  <img src="docs/showcase/hero.webp" alt="She Sharp landing — 'CONNECTING WOMEN IN TECHNOLOGY' hero with mountain backdrop, She# logo, 'Join Membership' CTA, and real event photography" width="100%">
</a>

![Demo: She Sharp walk-through — hero landing with mountain backdrop, scroll to reveal upcoming events grid (Aotearoa AI Hackathon, Working Smarter, Youth Tech Series), then navigate to the Mentorship Programme page with community photos](docs/showcase/demo.gif)

<details>
<summary>📅 Events & Mentorship pages</summary>

| All Events | Mentorship Programme | Mobile |
|---|---|---|
| <img src="docs/showcase/events-full.webp" width="340" alt="She Sharp /events — full page with Youth Tech Series, Aotearoa AI Hackathon Festival, Working Smarter, Her Waka and more event cards"> | <img src="docs/showcase/mentorship.webp" width="340" alt="She Sharp Mentorship Programme — 'Empowering Women in STEM through Mentoring' with real community photos"> | <img src="docs/showcase/mobile-home.webp" width="180" alt="She Sharp on mobile — She# logo, 'CONNECTING WOMEN IN TECHNOLOGY' headline, 'Attend our upcoming event' CTA"> |
...
She Sharp is a comprehensive mentorship platform dedicated to bridging the gender gap in STEM fields. Founded in 2014, we've built a thriving community of over 3500 women in technology, supported by 50+ corporate partners, and have hosted 95+ events to empower women in their STEM careers.
...
| [![Demo](https://img.shields.io/badge/TRY%20DEMO-ONLINE-9b2e83?labelColor=black&logo=vercel&style=for-the-badge)](https://www.shesharp.org.nz/) | Experience our platform without installation! |
| :--- | :--- |
...
- 🎯 **3500+** Active Community Members
- 🤝 **50+** Corporate Partners & Sponsors
- 📅 **95+** Events Since 2014
- 👩‍🏫 **18** Industry Mentors
...
- **Storage**: Vercel Blob (site assets and user uploads)
...
# Vercel Blob (user uploads: profile photos and CVs)
# Injected automatically on Vercel once the store is linked; set by hand
# locally with: vercel env pull .env.local
BLOB_READ_WRITE_TOKEN="vercel_blob_rw_your_store_id_your_secret"
...
<a href="https://www.shesharp.org.nz/">Live Site</a>
·
